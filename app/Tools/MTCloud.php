...
#   LastChange: 2016-06-12 17:22:27
#      History:
=============================================================================*/
...
class MTCloud{
    ...
    */
    public function courseGet($course_id, $expire = 86400, $options = []){
    ...
    */
     ...
     *  @param  array $options      可选参数
     */
    public function courseVisitorListAll($start_time, $end_time, $page = 1, $size = 10, $options = array()) {
        $params = array(
            'start_time' => $start_time,
            'end_time' => $end_time,
            'page' => $page,
     ...
     * @param array $options        可选参数
     */
    public function courseQaList($course_id, $page=1, $size = 10, $options = array()) {
        $params = array(
            'course_id' => $course_id,
            'page' => $page,
            'size' => $size,
    ...
    public function videoList($page,$expire = 3600) {
        $params = array('page' => $page, 'expire' => $expire);
     ...
     * @param   object      $course         创建视频课程的课程参数
     */
    public function videoUpload($fileName, $account, $accountType, $title, $nickname = '', $accountIntro = '', $segmentUpload = true, $course = []) {
        ...
        $options = array('nickname' => $nickname, 'accountIntro' => $accountIntro,'course' => $course);
    ...
    */
    public function statsFlowList($date_time, $end_time=null, $vtype=1, $ctype=0, $departmentID=null, $small = 0){
        $params = ['date_time' => $date_time,'vtype'=>$vtype];
        if($end_time){
    ...
    */
    public function statsRtc($start_time, $end_time = '', $departmentID = 0){
        $params = ['departmentID' => $departmentID,'start_time'=>$start_time,'end_time' => $end_time];
    ...
    public function consoleAutoLogin($uid, $expire = 3600, $target = ''){
        ...
        $params = array('id' => $uid, 'openID' => $this->openID, 'expire' => $expire);
